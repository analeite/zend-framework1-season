...
class Sam_RelatorioCancelamento extends FPDF {
    ...
    function BasicTable($data) {
        ...
        Zend_Debug::dump($data[0]["nome_titular"]);
        //Dados do titular
        $this->AddPage();
        $this->SetFont('Arial', 'B', 10);
        $this->Cell(30, 6, utf8_decode('Titular:'), 0, 0, 'L');
        $this->SetFont('Arial', '', 10);
        $this->Cell(45, 6, utf8_decode($data[0]["nome_titular"]), 0, 0, 'L');
        $this->Ln();
//        $this->SetFont('Arial', 'B', 10);
//        $this->Cell(30, 6, utf8_decode(utf8_encode('Contrato:')), 0, 0, 'L');
//        $this->SetFont('Arial', '', 10);
//        $this->Cell(90, 6, utf8_decode($data[0]['contrato']), 0, 0, 'L');
//        $this->SetFont('Arial', 'B', 10);
//        $this->Cell(30, 6, utf8_decode(utf8_encode('Familia:')), 0, 0, 'L');
//        $this->SetFont('Arial', 'B', 10);
//        $this->Cell(90, 6, utf8_decode($data[0]['familia']), 0, 0, 'L');
//        $this->SetFont('Arial', 'B', 10);
//        $this->Cell(40, 6, utf8_decode('Data de cancelamento:'), 0, 0, 'L');
//        $this->SetFont('Arial', '', 10);
//        $this->Cell(45, 6, utf8_decode($data[0]['data_cancelamento']), 0, 0, 'L');
//        $this->Ln();
//        $campos["Nome"] = 'Nome';
...
//        $this->Image('../public_html/imagens/pequeno.png', 10, 10);
        ...
        $this->Cell(240, 6, utf8_decode(utf8_encode('Movimentação Cadastral - Pessoa Física')), 0, 2, 'C');
