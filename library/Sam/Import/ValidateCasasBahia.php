...
class Sam_Import_ValidateCasasBahia extends Sam_Import_LayoutValidate {
    ...
    public function termcontrato($value) {
        if ($value == 17 || $value == 37 || $value == 47 || $value == 57)
            return true;
        else
            return false;
    }
 //var $dtNascimento ;
    ...
    public function graudependencia($value) {
        if (intval($value) >= 1 && intval($value) <= 5)
            return true;
        else
            return false;
    }
